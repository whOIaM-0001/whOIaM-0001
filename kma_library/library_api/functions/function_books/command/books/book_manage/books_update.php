...
// Nếu client không gửi TinhTrang nhưng có SoLuong, tự cập nhật TinhTrang theo SoLuong
if (!isset($input['TinhTrang']) && isset($input['SoLuong'])) {
  $calc = ((int)$input['SoLuong'] > 0) ? 'Còn' : 'Hết';
  $sets[] = "`TinhTrang` = ?"; $vals[] = $calc;
}
