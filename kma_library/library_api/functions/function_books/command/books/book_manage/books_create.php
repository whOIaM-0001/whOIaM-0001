...
try {
  // Tự tính TinhTrang theo SoLuong để lưu vào DB (Còn nếu >0, ngược lại Hết)
  $soLuong = isset($input['SoLuong']) ? (int)$input['SoLuong'] : 1;
  $tinhTrang = $soLuong > 0 ? 'Còn' : 'Hết';

  $sql = "INSERT INTO SACH (maS, TenS, MaTheLoai, Tacgia, NamXB, MaNhaXuatBan, SoLuong, TinhTrang)
          VALUES (?,?,?,?,?,?,?,?)";
