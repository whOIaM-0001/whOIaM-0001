...
(async function () {
  ...
  // Chỉ dùng aria-hidden, không cần set style.display (theo 06_modal.css)
  ...
  function openEditModal(tr) {
    const modalFormEl = getModalFormEl();
  ...
  // Always rebind modal close/cancel events after module load
  ...
  function bindRowActions() {
    ...
    // GỠ bỏ listener riêng cho .action-edit vì đã có handler ở cấp menu (openActionMenu)
